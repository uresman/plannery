...
<body>
    ...
    <section id="home-section" class="section">
        <div class="hero">
            <div class="container">
                ...
                <p>Find perfect venues, manage your budget, and book everything in one place.</p>
                <div id="hero-buttons">
    ...
    <footer>
        <div class="container">
            ...
            <p>&copy; 2023 Wedding Planner Pro. All rights reserved.</p>
            <p>This is a demonstration system. All data is simulated.</p>
        </div>
    </footer>
